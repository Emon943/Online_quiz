...
<div class="row">
<div class="col-lg-6">
<span class="logo">Testing you</span></div>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>abcd</b></a>
    </div>
...
<?php
$eid=@$_GET['eid'];
$results = mysqli_query($con,"SELECT * FROM quiz where eid='$eid'") or die('Error111');
...
echo  '<div class="panel title">
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Institute</b></td><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
...
<a href="http://www.abcd.com" target="_blank">About us</a>
</div>
